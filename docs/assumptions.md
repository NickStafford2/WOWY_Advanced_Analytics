...
- The WOWY score does not use minutes played.
...
- The WOWY path uses `minutes` only for output qualification filters when running from cache-managed normalized inputs.
