...
def test_audit_nba_source_reports_known_classifications_without_failure(tmp_path: Path) -> None:
    ...
    _write_box_score_payload(
        ...
        player_rows=[
            ...
            ["0001", 1610612763, "MEM", 2001, "Inactive Player", None, "DNP - Coach's Decision", None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None],
...
def test_source_audit_cli_returns_nonzero_for_hard_failures(tmp_path: Path, capsys) -> None:
    ...
    _write_box_score_payload(
        tmp_path / "boxscores" / "0001_boxscoretraditionalv2.json",
        player_rows=[
            ["0001", 1610612763, "MEM", 1, "", "48:00", "", None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None],
            ["0001", 1610612738, "BOS", 10, "Opp", "48:00", "", None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None],
        ],
        team_rows=[
            [1610612763, "MEM", 5, 100],
