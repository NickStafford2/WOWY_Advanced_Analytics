...
from rawr_analytics.metrics.wowy import WowyQuery, WowyQueryFilters, build_wowy_custom_query
...
from rawr_analytics.metrics.wowy import build_export_table as _build_wowy_export_table
from rawr_analytics.metrics.wowy import (
...
def build_rawr_options_payload(query: RawrQuery) -> MetricOptionsPayload:
    ...
    return _build_options_payload(snapshot, filters=filters)
...
def _build_wowy_view_payload(
    ...
    *,
    ...
    if view == "custom-query":
        ...
        return _build_wowy_custom_leaderboard_payload(
            metric,
            result,
            top_n=query.top_n,
        )
...
def _build_scope_key(query: RawrQuery | WowyQuery) -> str:
